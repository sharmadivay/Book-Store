  ...
  return (
    ...
    <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10 ">
      <div className="w-full md:w-1/2 mt-12 md:mt-24 order-2 md:order-1">
        ...
        <p className="text-xl">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Velit est ullam delectus expedita facilis tenetur, quidem esse magnam quibusdam. Debitis aperiam quas eveniet hic sunt voluptates aut dolorem aliquid iusto!</p>
